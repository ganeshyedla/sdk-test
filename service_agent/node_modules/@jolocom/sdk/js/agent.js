...
class Agent {
    ...
    async credOfferToken(offer) {
        const token = await this.idw.create.interactionTokens.request.offer(offer, await this.passwordStore.getPassword());
        await this.interactionManager.start(token);
        return token.encode();
    }
    /**
    ...
    async signedCredential(credParams) {
        return await this.idw.create.signedCredential(credParams, await this.passwordStore.getPassword());
    }
    /**
