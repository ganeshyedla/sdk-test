...
export declare const infura = "https://rinkeby.infura.io/v3/64fa85ca0b28483ea90919a83630d5d8";
export declare const jolocomContract = "0xd4351c3f383d79ba378ed1875275b1e7b960f120";
export declare const jolocomIpfsHost = "https://ipfs.jolocom.com:443";
/**
 ...
 */
export declare function getRegistrar(providerUrl?: string, contractAddress?: string, ipfsHost?: string): {
    /**
     ...
     */
    broadcastTransaction: (transactionHex: string, signature: SignatureLike) => Promise<import("@ethersproject/abstract-provider").TransactionResponse>;
    /**
